...
public class AdminLoginController extends BaseController {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "admin/login/icon",method = RequestMethod.GET,produces = "application/json;charset=utf-8")
    public String GetIcon( @RequestParam String username){
        ...
        if(admin == null){
            ...
            object.put("success", true);
            object.put("srcString", admin.getAdmin_icon());
        }
        return object.toJSONString();
    }
}
