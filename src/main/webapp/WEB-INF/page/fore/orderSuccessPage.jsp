...
<head>
    ...
    <title>交易成功 - 校园超市-理想生活上校园超市</title>
</head>
<body>
<nav>
            ...
            <c:if test="${requestScope.product != null}">
                <div class="successInfo">
                    <ul class="info-rate-coin">
                        <li>
                            <span class="review_msg">认真填写商品评价，就有机会获得20点校园超市经验值！</span>
                            <a class="J_makePoint"
                               href="${pageContext.request.contextPath}/review/${requestScope.orderItem.orderItem_id}">
