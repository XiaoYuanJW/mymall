    ...
    <div class="content_main">
        <div id="J_AmountList">
            ...
            <div class="summary_pay_done">
                <ul>
                    <li>
                        收货地址：<span>${requestScope.order.order_detail_address} ${requestScope.order.order_receiver} ${requestScope.order.order_phone}</span>
                    </li>
            ...
            <ul>
                <li class="alertLi">
                    <p>
                        ...
                        <span class="info">！校园超市不存在系统升级，订单异常等问题，谨防假冒客服电话诈骗！</span>
                    </p>
                </li>
            </ul>
        </div>
