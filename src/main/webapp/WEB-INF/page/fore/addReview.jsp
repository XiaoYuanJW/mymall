...
<head>
    ...
    <title>添加评论 - 校园超市-理想生活上校园超市</title>
    <script>
        $(function () {
...
<div class="content">
    <div class="details_box">
        <div class="db-showpanel">
            <a href="${pageContext.request.contextPath}/product/${orderItem.orderItem_product.product_id}"
               target="_blank"><img
                    src="${pageContext.request.contextPath}/res/images/item/productSinglePicture/${orderItem.orderItem_product.singleProductImageList[0].productImage_src}"></a>
        </div>
        <div class="db-icbu">
            <ol class="ui-form-bd">
                <li class="ui-form-row"><h3>${orderItem.orderItem_product.product_name}</h3></li>
                <li class="ui-form-row superstar-price">
                    <label class="ui-form-label">价格</label>
                    <div class="ui-form_right">
                        <em>${orderItem.orderItem_product.product_sale_price}</em>
                        <span>元</span>
                    </div>
                </li>
        ...
        <div class="banner-totalevolute">
            <div class="tv-leftbox">
                ...
                <div class="tv-lb-content">
                    <span>累计评价</span>
                    <em class="superstar-ratetotal">${orderItem.orderItem_product.product_review_count}</em>
                </div>
        ...
        <div class="rate-compose">
            <form method="post" action="${pageContext.request.contextPath}/review" id="review_form">
                <input type="hidden" class="orderItem_id" value="${orderItem.orderItem_id}" name="orderItem_id">
