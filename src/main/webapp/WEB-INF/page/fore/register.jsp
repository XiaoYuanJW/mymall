...
<div class="content">
    ...
    <div class="form-list">
        <div class="form-item">
            <label class="form-label form-label-b tsls">设置用户名</label>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <input name="user_nickname" id="user_nickname" class="form-text err-input" placeholder="请输入昵称" maxlength="20">
            <span class="form_span"></span>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <input name="user_address" id="user_address" class="form-text err-input" placeholder="请输入地址" maxlength="20">
            <span class="form_span"></span>
        </div>
        <div class="form-item">
