        ...
        $(function () {
            if($("#details_product_id").val() === ""){
                ...
                $("#btn_product_save").click(function () {
                    ...
                    if(product_brand === ""){
                        styleUtil.basicErrorShow($("#lbl_product_brand"));
                        yn = false;
                    }
...
<div class="details_div">
    ...
    <div class="frm_div">
        ...
        <label class="frm_label text_info" id="lbl_product_brand" for="input_product_brand">产品品牌</label>
        <input class="frm_input" id="input_product_brand" type="text" maxlength="50" value="${requestScope.product.product_brand}"/>
    </div>
    ...
    <div class="frm_div">
        <label class="frm_label text_info" id="lbl_product_description" for="input_product_description">产品描述</label>
        <input class="frm_input" id="input_product_description" type="text" maxlength="50" value="${requestScope.product.product_description}"/>
        <label class="frm_label text_info" id="lbl_product_inventory" for="input_product_inventory">产品库存</label>
        <input class="frm_input" id="input_product_inventory" type="text" maxlength="50" value="${requestScope.product.product_inventory}"/>
    </div>
</div>
<div class="details_div">
