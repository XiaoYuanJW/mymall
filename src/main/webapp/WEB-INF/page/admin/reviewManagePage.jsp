...
<div class="frm_div text_info">
    ...
    <div class="frm_group">
        ...
        <label class="frm_label" id="lbl_review_stars_two" for="checkbox_review_stars_two">2星</label>
        <input id="checkbox_review_stars_three" name="checkbox_review_stars" type="checkbox" value="3" checked>
        <label class="frm_label" id="lbl_review_stars_three" for="checkbox_review_stars_three">3星</label>
        <input id="checkbox_review_stars_four" name="checkbox_review_stars" type="checkbox" value="4" checked>
        <label class="frm_label" id="lbl_review_stars_four" for="checkbox_review_stars_four">4星</label>
        <input id="checkbox_review_stars_five" name="checkbox_review_stars" type="checkbox" value="5" checked>
