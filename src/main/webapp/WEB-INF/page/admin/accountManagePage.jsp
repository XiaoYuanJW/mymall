    ...
    <script>
        $(function () {
            ...
            $("#btn_admin_save").click(function () {
                ...
                var admin_icon = null;
                var admin_phone = $.trim($("#input_admin_phone").val());;
                var admin_email = $.trim($("#input_admin_email").val());;
        ...
        function uploadImage(fileDom) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        $("#admin_icon").addClass("new").attr("src", "${pageContext.request.contextPath}/res/images/item/adminProfilePicture/" + data.fileName);
                    } else {
                        alert("图片上传异常！");
                    }
                },
...
<div class="details_div">
    ...
    <div class="frm_div">
        <label class="frm_label text_info" id="lbl_admin_phone" for="input_admin_phone">管理员电话</label>
        <input class="frm_input" id="input_admin_phone" type="text" maxlength="50"
               value="${requestScope.admin.admin_phone}"/>
    </div>
<%--    <span class="details_value" id="span_admin_phone">${requestScope.admin.admin_phone}</span>--%>
    <div class="frm_div">
        <label class="frm_label text_info" id="lbl_admin_email" for="input_admin_email">管理员邮箱</label>
        <input class="frm_input" id="input_admin_email" type="text" maxlength="50"
               value="${requestScope.admin.admin_email}"/>
    </div>
</div>
<div class="details_div">
